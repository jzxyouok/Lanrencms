              ...
              <div class="box">
                ...
                <div class="box-header">
                    <div style="float:left;margin:0 8px;">
                      <a href="<?php echo U("Type/article_add");?>" class="btn btn-block btn-default"><i class="fa fa-fw fa-plus"></i>添加</a>
                    </div>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo['id']); ?></td>
                             ...
                             <td>
                              ...
                              <td>
                                 <?php
 $jg = M("Arctype")->where("id=".$vo['typeid'])->field("id,typename")->find(); echo '<a href="'.U("Type/article",array("typeid"=>$vo['typeid'])).'">'.$jg['typename'].'</a>'; ?>
                              </td>                              
                              <td>
                                 <?php echo ($vo['click']); ?>
                              </td>
                              <td>
                                <a title="编辑" href="<?php echo U("Type/article_edit",array("id"=>$vo['id']));?>"><i class="fa fa-fw fa-edit"></i></a> | <a onclick="return window.confirm('确定删除？');" title="删除" href="<?php echo U("Type/article_delete",array("id"=>$vo['id']));?>"><i class="fa fa-fw fa-remove"></i></a>
                              </td>
              ...
              <div class="box">
                <div class="box-body">
                    ...
                    <!-- search form -->
                    <form action="<?php echo U("Type/article");?>" method="get" class="sidebar-form">
                      <div class="input-group">
                        <input type="text" name="q" class="form-control" placeholder="<?php echo empty($_GET['q'])?"按标题搜索":$_GET['q'];?>">
                        <span class="input-group-btn">
                          <button type="submit" name="search" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i></button>
                        </span>
                      </div>
