...
<div class="goto">→</div>
        ...
        <div id="previewbox">
                ...
                <div style="font-size:18px;line-height:24px;font-weight:700">久恒果优，专注于微信公众号</div>
