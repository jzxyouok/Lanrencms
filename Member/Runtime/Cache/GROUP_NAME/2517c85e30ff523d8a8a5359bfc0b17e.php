        ...
        <div class="pad margin no-print">
          <div class="callout callout-info" style="margin-bottom: 0!important;">
            <h4><i class="fa fa-info"></i> 公告:</h4>
              <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><?php echo ($vo["title"]); ?> <button data-toggle="modal" data-target="#nt_<?php echo ($vo["id"]); ?>" class="btn btn-success btn-xs">点击详细查看</button> </li>
