<?php if (!defined('THINK_PATH')) exit();?><html lang="zh-CN"><head>
	...
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo C('site_url'); ?>/Home/Tpl/Index/pbl/data/style.css?ver=2">
...
<title>上传</title>
<script src="__PUBLIC__/static/jquery-1.4.2.min.js" type="text/javascript"></script>
...
<p><div><div style="font-size:14px;">选择本地文件：<br><br><input type="file" style="width:80%;border:1px solid #ddd" name="photo"></input></div><div style="padding:20px 0;text-align:center;"><input id="submitbtn" name="doSubmit" type="submit" class="btnGreen" value="上传" onclick="this.value='上传中...'"></input> 
...
<?php }else{ ?>
<div style="text-align:center;line-height:140px;font-size:14px;"> <img src="__PUBLIC__/images/export.png" align="absmiddle" /> <?php if($_GET['error']==0){echo '上传成功';}else{echo $_GET['msg'];} ?> </div>
<script>
