                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo["pname"]); ?>(<?php echo ($vo["oldinfo"]); ?>)</td>
                            <td><?php echo (date("Y-m-d H:i:s",$vo["mtime"])); ?></td>
                            <td><?php echo ($vo["money"]); ?></td>
                            <td>
                                <?php if(($vo["sta"]) == "0"): ?><span class="label label-warning">未付款</span>
                                    <a href="<?php echo U("Member/payUrl",array("aid"=>$vo['aid']));?>" target='_blank'>去付款</a><?php endif; ?>
